export default {
  ...
  head: {
    ...
    meta: [
      ...
      {
        content: "https://cryptobitlimited.com/Cryptobit-Logo.png",
        property: "og:image",
      },
      {
        content: "Make a Good Decision Now... Join The Profitable Community.",
      ...
      {
        content: "Join Renex Holdings Now... Make Profits Daily",
  ...
  plugins: [
    ...
    // { src: "~/plugins/bitcoinChart.js", mode: "client" },
  ...
  axios: {
    baseURL: "https://bitlimit-production.up.railway.app/api",
  },
  publicRuntimeConfig: {
    FILE_URL: "https://bitlimit-production.up.railway.app/uploads",
  },
